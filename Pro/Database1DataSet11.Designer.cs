...
namespace Pro {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string Фамилия, string Имя) {
...
namespace Pro.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Фамилия = 1 " +
                "AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1" +
                " AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Фамилия], [Имя]) VALUES (@Фамилия, @Имя);\r\nSELECT Id," +
                " Фамилия, Имя FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Фамилия] = @Фамилия, [Имя] = @Имя WHERE (([Id] = @Original_Id) AND ((@IsNull_Фамилия = 1 AND [Фамилия] IS NULL) OR ([Фамилия] = @Original_Фамилия)) AND ((@IsNull_Имя = 1 AND [Имя] IS NULL) OR ([Имя] = @Original_Имя)));
SELECT Id, Фамилия, Имя FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Pro.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Фамилия, Имя FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Фамилия, string Original_Имя) {
        ...
        public virtual int Update(string Фамилия, string Имя, int Original_Id, string Original_Фамилия, string Original_Имя, int Id) {
            if ((Фамилия == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Фамилия, string Имя, int Original_Id, string Original_Фамилия, string Original_Имя) {
            return this.Update(Фамилия, Имя, Original_Id, Original_Фамилия, Original_Имя, Original_Id);
        }
    }
